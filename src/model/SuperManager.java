...
public class SuperManager extends User {
    public SuperManager(String username, String password, String name, String gender, String email, String phoneNumber, String dateOfBirth) {
        super(username, password, name, "SuperManager", gender, email, phoneNumber, dateOfBirth);
    }
